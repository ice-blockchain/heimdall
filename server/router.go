...
func RootHandler[REQ, RESP any, ERR interface{ InternalErr() error }](handleRequest func(context.Context, *Request[REQ, RESP]) (*Response[RESP], *ErrResponse[ERR])) func(*gin.Context) {
	return func(ginCtx *gin.Context) {
		...
		reqCtx = context.WithValue(reqCtx, EndpointUrlCtxValueKey, ginCtx.Request.URL.Path) //nolint:staticcheck,revive // .
...
func AuthorizeWithCustomAuthStore(ctx context.Context, ginCtx *gin.Context, allowUnauthorized bool, getAuth func(ginCtx *gin.Context) string) (authUser Token, errResp *ErrResponse[*ErrorResponse]) {
	...
	if userID == "" {
		userID = strings.Trim(ginCtx.Param("userIdOrMasterKey"), " ")
	}
