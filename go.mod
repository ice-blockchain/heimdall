...
require (
	...
	github.com/ice-blockchain/subzero v1.471.0
	github.com/ice-blockchain/wintr v1.169.0
...
require (
	...
	github.com/dundee/gdu/v5 v5.32.1-0.20251128145232-88943f7861a0 // indirect
