...
replace (
	github.com/envoyproxy/go-control-plane v0.13.2 => github.com/envoyproxy/go-control-plane v0.13.1
...
require (
	...
	github.com/xssnick/tonutils-go v1.10.1-0.20240930074557-a0eeb518ae2c
