...
replace (
	github.com/getsentry/sentry-go => github.com/getsentry/sentry-go v0.43.0
...
require (
	...
	github.com/fingerprintjs/fingerprint-pro-server-api-go-sdk/v7 v7.10.0
	...
	github.com/ice-blockchain/subzero v1.546.0
