...
var networks = map[string]*Network{
	"Algorand": &Network{
		...
		ExplorerURL:        "https://explorer.perawallet.app/tx/{txHash}/",
	...
	"Plume": &Network{
		ID:                 "Plume",
		CoinGeckoNetworkID: "plume",
		CoinGeckoPlatform:  "plume-network",
		DisplayName:        "Plume",
		IsTestnet:          false,
		Image:              "https://coin-images.coingecko.com/asset_platforms/images/22226/large/Logomark-BG-Red.png?1746672975",
		ExplorerURL:        "https://explorer.plume.org/tx/{txHash}",
		DefaultDecimals:    18,
		SkipSyncTokens:     true,
		Tier:               1,
		PrioritizedCoins:   nil,
	},
	"PlumeCodexSepolia": &Network{
		ID:                 "PlumeSepolia",
		CoinGeckoNetworkID: "plume",
		CoinGeckoPlatform:  "plume-network",
		DisplayName:        "Plume",
		IsTestnet:          true,
		Image:              "https://coin-images.coingecko.com/asset_platforms/images/22226/large/Logomark-BG-Red.png?1746672975",
		ExplorerURL:        "https://testnet-explorer.plume.org/tx/{txHash}",
		DefaultDecimals:    18,
		SkipSyncTokens:     true,
		Tier:               1,
		PrioritizedCoins:   nil,
	...
	"Near": &Network{
		ID:                 "Near",
		CoinGeckoNetworkID: "near",
		CoinGeckoPlatform:  "near-protocol",
		DisplayName:        "Near",
		IsTestnet:          false,
		Image:              "https://cdn.ice.io/online+/assets/coins/near.svg",
		ExplorerURL:        "https://nearblocks.io/txns/{txHash}",
		DefaultDecimals:    24,
		SkipSyncTokens:     false,
		Tier:               2,
		PrioritizedCoins:   nil,
	},
	"NearTestnet": &Network{
	...
	"Bob": &Network{
		...
		DisplayName:        "BOB Network",
		IsTestnet:          false,
		Image:              "https://coin-images.coingecko.com/asset_platforms/images/255/large/bob.jpeg",
		ExplorerURL:        "https://explorer.gobob.xyz/tx/{txHash}",
		DefaultDecimals:    18,
		SkipSyncTokens:     false,
		Tier:               1,
		PrioritizedCoins:   []string{"weth"},
	},
	"BobSepolia": &Network{
		ID:                 "BobSepolia",
		CoinGeckoNetworkID: "bob-network",
		...
		IsTestnet:          true,
		Image:              "https://coin-images.coingecko.com/asset_platforms/images/255/large/bob.jpeg",
		ExplorerURL:        "https://bob-sepolia.explorer.gobob.xyz/tx/{txHash}",
		DefaultDecimals:    18,
		SkipSyncTokens:     false,
		Tier:               1,
		PrioritizedCoins:   []string{"weth"},
